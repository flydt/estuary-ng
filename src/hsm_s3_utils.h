...
static S3ResponseHandler getResponseHandler = { &responseGetObjectPropertiesCallback,
					 &getResponseCompleteCallback };

static S3ResponseHandler putResponseHandler = { &responsePropertiesCallback,
					 &putResponseCompleteCallback };

static S3ResponseHandler headResponseHandler = { &responsePropertiesCallback,
					  &getResponseCompleteCallback };

static S3ResponseHandler deleteResponseHandler = { &responsePropertiesCallback,
					    &getResponseCompleteCallback };

static S3MultipartInitialHandler multipart_init_handler = {
	{
...
static S3PutObjectHandler multipart_upload_part_handler = {
	{
...
static S3MultipartCommitHandler multipart_commit_handler = {
